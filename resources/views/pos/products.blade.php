...
<div class="row">
  ...
  <table class="table">
        ...
        <tr>
            ...
            <td >
            <a href="{{ route('add.to.cart', $product->id) }}" class="btn btn-primary btn-sm btn-block text-center" role="button">Add to cart</a>
                    </td>
</tr>
@endforeach
        ...
        @if(session('cart'))
            ...
            @csrf
                <tr data-id="{{ $id }}">
                    ...
                    <input type="text" name="subtotal[]" value=" ${{ $details['price'] * $details['quantity'] }}" hidden=""/>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" class="text-right">
                <input type="text" class="form-control" name="description" style="font-size:25px;" placeholder="Amount Given" required/>
            </td>
        </tr>
        <tr>
            <td colspan="5" class="text-right">
