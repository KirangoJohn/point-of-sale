...
@include('navbar')
<div class="container">
<h1>Retail Sales Report by Date</h1>
<hr>
<div class="row">
    <div class="col" ><form action="{{ route('retailsalesbydatereports.index') }}" method="GET">
    <div class="row">
...
function printDivContent() {
     ...
     windows.document.write('</style>');
 	windows.document.write('<body> <div class="container"><table class="table"> <h1>Retail Sales Report By Date</h1><br> <p> Printing Date: <?php echo date('Y-m-d');?></p> <hr>');
